...
void MVPSet(Shader &myShader);
// void MatrixMSet(Shader &myShader);
// void MatrixVSet(Shader &myShader);
// void MatrixPSet(Shader &myShader);
...
void TextureSet(Shader &myShader){
    ...
    unsigned char *data = stbi_load("../models/container.jpg", &width, &height, &channel, 0);
    if (data){
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    data = stbi_load("../models/awesomeface.png", &width, &height, &channel, 0);
    if (data){
